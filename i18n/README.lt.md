...
| `state_content`         | string arba list | Optional | `state`, atributo pavadinimas, šablonas | Ką rodo eilutė po pavadinimu, žr. mygtuko parinktis. Senas raktas `show_state` vis dar veikia. |
