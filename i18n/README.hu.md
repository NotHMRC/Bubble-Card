...
| `state_content`         | string vagy list | Opcionális | `state`, egy attribútum neve, egy sablon | Mit mutat a név alatti sor, lásd a gomb beállításait. A régi `show_state` kulcs továbbra is működik. |
