...
यह हर उस एंटिटी के साथ भी काम करता है जो अपने विकल्पों को एक एट्रिब्यूट लिस्ट के रूप में दिखाती है: क्लाइमेट पर `hvac_modes`, `fan_modes`, `swing_modes`, `swing_horizontal_modes` और `preset_modes`, ह्यूमिडिफ़ायर पर `available_modes`, वॉटर हीटर पर `operation_list`, लाइट पर `effect_list`, तथा मीडिया प्लेयर पर `source_list` और `sound_mode_list`।
...
यह कार्ड आपको अपनी `climate`, `humidifier` और `water_heater` एंटिटी को नियंत्रित करने देता है। किसी ह्यूमिडिफ़ायर, डीह्यूमिडिफ़ायर या सामान्य हाइग्रोस्टेट को उसकी लक्ष्य आर्द्रता पर वही प्लस और माइनस नियंत्रण मिलते हैं, और वॉटर हीटर को उसके लक्ष्य तापमान पर।

> [!TIP]
> मोड चयन मेनू एक [सब-बटन](#सब-बटन) है जो कार्ड बनाते समय स्वचालित रूप से जोड़ा जाता है। फिर आप इसे अपनी इच्छानुसार बदल या हटा सकते हैं। यह किसी क्लाइमेट एंटिटी के `hvac_modes`, ह्यूमिडिफ़ायर के `available_modes` और वॉटर हीटर के `operation_list` को पढ़ता है।
...
| नाम                     | प्रकार    | आवश्यकता                         | समर्थित विकल्प                                  | विवरण                                                                                                     |
|--------------------------|---------|-------------------------------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| `entity`                | string  | **आवश्यक**                        | क्लाइमेट, ह्यूमिडिफ़ायर या वॉटर हीटर एंटिटी      | नियंत्रित करने के लिए एंटिटी (जैसे `climate.living_room`, `humidifier.bedroom` या `water_heater.boiler`)।             |
...
| `state_content`         | string या list | वैकल्पिक | `state`, कोई एट्रिब्यूट नाम, कोई टेम्पलेट | नाम के नीचे वाली लाइन क्या दिखाती है, बटन के विकल्प देखें। पुराना `show_state` विकल्प अब भी काम करता है। |
...
| `state_color`           | boolean | वैकल्पिक                            | `true` या `false` (डिफ़ॉल्ट)                     | जब एंटिटी चालू हो तो एक स्थिर बैकग्राउंड कलर लागू करता है। वॉटर हीटर में `hvac_action` जैसा कुछ नहीं होता, इसलिए उसे रंग देने वाली यही एकमात्र चीज़ है। |
| `step` | number | वैकल्पिक | कोई भी संख्या | लक्ष्य वैल्यू, तापमान या आर्द्रता का स्टेप। |
| `min_temp` | number | वैकल्पिक | कोई भी संख्या | न्यूनतम लक्ष्य वैल्यू। ह्यूमिडिफ़ायर पर यह आर्द्रता होती है, तापमान नहीं। |
| `max_temp` | number | वैकल्पिक | कोई भी संख्या | अधिकतम लक्ष्य वैल्यू। ह्यूमिडिफ़ायर पर यह आर्द्रता होती है, तापमान नहीं। |
| `button_action` | object | वैकल्पिक | `tap_action`, `double_tap_action` या `hold_action`, देखें [एक्शन](#टैप-डबल-टैप-और-होल्ड-एक्शन) | बटन क्लिक पर डिफ़ॉल्ट एक्शन बदलने देता है। |
| `tap_action` | object | वैकल्पिक | देखें [एक्शन](#टैप-डबल-टैप-और-होल्ड-एक्शन) | आइकन क्लिक पर एक्शन का प्रकार परिभाषित करें, यदि परिभाषित नहीं है तो `more-info` का उपयोग होगा। |
| `double_tap_action` | object | वैकल्पिक | देखें [एक्शन](#टैप-डबल-टैप-और-होल्ड-एक्शन) | आइकन डबल क्लिक पर एक्शन का प्रकार परिभाषित करें, यदि परिभाषित नहीं है तो `none` का उपयोग होगा। |
| `hold_action` | object | वैकल्पिक | देखें [एक्शन](#टैप-डबल-टैप-और-होल्ड-एक्शन) | आइकन होल्ड पर एक्शन का प्रकार परिभाषित करें, यदि परिभाषित नहीं है तो `more-info` का उपयोग होगा। |                              |
...
| `--bubble-state-humidifier-on-color` | `color` | चल रहे ह्यूमिडिफ़ायर के लिए ओवरले कलर |
| `--bubble-state-humidifier-humidifier-on-color` | `color` | चल रहे ह्यूमिडिफ़ायर के लिए ओवरले कलर, जब उसकी डिवाइस क्लास `humidifier` हो |
| `--bubble-state-humidifier-dehumidifier-on-color` | `color` | चल रहे डीह्यूमिडिफ़ायर के लिए ओवरले कलर, जब उसकी डिवाइस क्लास `dehumidifier` हो |
| `--bubble-state-water_heater-<operation>-color` | `color` | वॉटर हीटर के किसी ऑपरेशन के लिए ओवरले कलर, जैसे `--bubble-state-water_heater-eco-color` |
