...
| `state_content`         | string vai list | Optional | `state`, atribūta nosaukums, veidne | Ko rāda rinda zem nosaukuma, skatiet pogas opcijas. Vecā atslēga `show_state` joprojām darbojas. |
