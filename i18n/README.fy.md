...
| `state_content`         | string of list | Opsjoneel | `state`, in attribútnamme, in sjabloan | Wat de rigel ûnder de namme toant, sjoch de knopopsjes. De âlde kaai `show_state` wurket noch altyd. |
