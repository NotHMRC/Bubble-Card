...
| `state_content`         | string neu list | Dewisol | `state`, enw priodoledd, templed | Yr hyn y mae'r llinell o dan yr enw yn ei ddangos, gweler opsiynau'r botwm. Mae'r hen allwedd `show_state` yn dal i weithio. |
