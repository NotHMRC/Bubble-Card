...
| `state_content`         | string of list | Opsioneel | `state`, 'n attribuutnaam, 'n sjabloon | Wat die reël onder die naam wys, sien die knoppie-opsies. Die ou sleutel `show_state` werk steeds. |
