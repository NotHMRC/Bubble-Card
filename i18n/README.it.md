...
| `state_content`         | string or list | Opzionale | `state`, il nome di un attributo, un template | Cosa mostra la riga sotto il nome, vedi le opzioni del pulsante. La vecchia chiave `show_state` funziona ancora. |
