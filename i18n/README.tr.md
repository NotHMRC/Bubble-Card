...
| `state_content`         | string veya list | Optional | `state`, bir özellik adı, bir şablon | Adın altındaki satırın ne gösterdiği, düğme seçeneklerine bakın. Eski `show_state` anahtarı hâlâ çalışır. |
