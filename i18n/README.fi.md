...
| `state_content`         | string tai list | Valinnainen | `state`, attribuutin nimi, malli | Mitä nimen alla oleva rivi näyttää, katso painikkeen asetukset. Vanha avain `show_state` toimii edelleen. |
