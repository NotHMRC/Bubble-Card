...
| `popup_style` | string | ఐచ్ఛికం | `bubble` (డిఫాల్ట్), `classic` లేదా `home-assistant` | పాప్-అప్ విజువల్ స్టైల్‌ను నిర్వచించండి |
...
తన ఎంపికలను ఒక అట్రిబ్యూట్ జాబితాగా అందించే ఏ ఎంటిటీతోనైనా ఇది పనిచేస్తుంది: ఒక క్లైమేట్‌పై `hvac_modes`, `fan_modes`, `swing_modes`, `swing_horizontal_modes` మరియు `preset_modes`, ఒక హ్యుమిడిఫైయర్‌పై `available_modes`, ఒక వాటర్ హీటర్‌పై `operation_list`, ఒక లైట్‌పై `effect_list`, ఒక మీడియా ప్లేయర్‌పై `source_list` మరియు `sound_mode_list`.
...
ఈ కార్డ్ మీ `climate`, `humidifier` మరియు `water_heater` ఎంటిటీలను నియంత్రించడానికి మిమ్మల్ని అనుమతిస్తుంది. ఒక హ్యుమిడిఫైయర్, ఒక డీహ్యుమిడిఫైయర్ లేదా ఒక సాధారణ హైగ్రోస్టాట్ దాని లక్ష్య తేమ కోసం అవే ప్లస్ మరియు మైనస్ నియంత్రణలను పొందుతుంది, మరియు ఒక వాటర్ హీటర్ దాని లక్ష్య ఉష్ణోగ్రత కోసం వాటిని పొందుతుంది.

> [!TIP]
> మోడ్ ఎంపిక మెనూ అనేది కార్డ్‌ను సృష్టించేటప్పుడు స్వయంచాలకంగా జోడించబడే ఒక [సబ్-బటన్](#సబ్-బటన్లు). మీరు దీన్ని మీ ఇష్టానుసారం సవరించవచ్చు లేదా తీసివేయవచ్చు. ఇది ఒక క్లైమేట్ ఎంటిటీ యొక్క `hvac_modes`, ఒక హ్యుమిడిఫైయర్ యొక్క `available_modes` మరియు ఒక వాటర్ హీటర్ యొక్క `operation_list` చదువుతుంది.
...
| పేరు                     | రకం    | అవసరం                         | మద్దతు ఉన్న ఎంపికలు                                  | వివరణ                                                                                                     |
|--------------------------|---------|-------------------------------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| `entity`                | string  | **అవసరం**                        | వాతావరణ నియంత్రణ, హ్యుమిడిఫైయర్ లేదా వాటర్ హీటర్ ఎంటిటీ   | నియంత్రించాల్సిన ఎంటిటీ (ఉదా. `climate.living_room`, `humidifier.bedroom` లేదా `water_heater.boiler`).           |
...
| `state_color`           | boolean | ఐచ్ఛికం                            | `true` లేదా `false` (డిఫాల్ట్)                     | ఎంటిటీ ఆన్‌లో ఉన్నప్పుడు స్థిరమైన బ్యాక్‌గ్రౌండ్ రంగును వర్తింపజేస్తుంది. ఒక వాటర్ హీటర్‌కు `hvac_action` వంటిది ఏదీ లేదు, కాబట్టి దానికి రంగు ఇచ్చేది ఇది ఒక్కటే. |
| `step` | number | ఐచ్ఛికం | ఏదైనా సంఖ్య | లక్ష్య విలువ, ఉష్ణోగ్రత లేదా తేమ యొక్క స్టెప్. |
| `min_temp` | number | ఐచ్ఛికం | ఏదైనా సంఖ్య | కనీస లక్ష్య విలువ. ఒక హ్యుమిడిఫైయర్‌పై ఇది ఉష్ణోగ్రత కాదు, తేమ. |
| `max_temp` | number | ఐచ్ఛికం | ఏదైనా సంఖ్య | గరిష్ట లక్ష్య విలువ. ఒక హ్యుమిడిఫైయర్‌పై ఇది ఉష్ణోగ్రత కాదు, తేమ. |
| `button_action` | object | ఐచ్ఛికం | `tap_action`, `double_tap_action` లేదా `hold_action`, [చర్యలు](#నొక్కడం-రెండుసార్లు-నొక్కడం-మరియు-నొక్కి-పట్టుకోవడం-చర్యలు) చూడండి | బటన్ క్లిక్‌పై డిఫాల్ట్ చర్యలను మార్చడానికి అనుమతించండి. |
| `tap_action` | object | ఐచ్ఛికం | [చర్యలు](#నొక్కడం-రెండుసార్లు-నొక్కడం-మరియు-నొక్కి-పట్టుకోవడం-చర్యలు) చూడండి | ఐకాన్ క్లిక్‌పై చర్య రకాన్ని నిర్వచించండి, నిర్వచించకపోతే `more-info` ఉపయోగించబడుతుంది. |
| `double_tap_action` | object | ఐచ్ఛికం | [చర్యలు](#నొక్కడం-రెండుసార్లు-నొక్కడం-మరియు-నొక్కి-పట్టుకోవడం-చర్యలు) చూడండి | ఐకాన్ డబుల్ క్లిక్‌పై చర్య రకాన్ని నిర్వచించండి, నిర్వచించకపోతే `none` ఉపయోగించబడుతుంది. |
| `hold_action` | object | ఐచ్ఛికం | [చర్యలు](#నొక్కడం-రెండుసార్లు-నొక్కడం-మరియు-నొక్కి-పట్టుకోవడం-చర్యలు) చూడండి | ఐకాన్ నొక్కి పట్టుకోవడంపై చర్య రకాన్ని నిర్వచించండి, నిర్వచించకపోతే `more-info` ఉపయోగించబడుతుంది. |                              |
...
| `--bubble-state-humidifier-on-color` | `color` | నడుస్తున్న ఒక హ్యుమిడిఫైయర్ కోసం ఓవర్‌లే రంగు |
| `--bubble-state-humidifier-humidifier-on-color` | `color` | నడుస్తున్న ఒక హ్యుమిడిఫైయర్ కోసం ఓవర్‌లే రంగు, దాని డివైస్ క్లాస్ `humidifier` అయినప్పుడు |
| `--bubble-state-humidifier-dehumidifier-on-color` | `color` | నడుస్తున్న ఒక డీహ్యుమిడిఫైయర్ కోసం ఓవర్‌లే రంగు, దాని డివైస్ క్లాస్ `dehumidifier` అయినప్పుడు |
| `--bubble-state-water_heater-<operation>-color` | `color` | ఒక వాటర్ హీటర్ ఆపరేషన్ కోసం ఓవర్‌లే రంగు, ఉదా. `--bubble-state-water_heater-eco-color` |
...
> [!NOTE]
> షరతులు మీ బ్రౌజర్‌లో మూల్యాంకనం చేయబడతాయి, కాబట్టి Home Assistant సర్వర్ అవసరమయ్యే కొన్ని షరతులు ఖచ్చితంగా ఉండలేవు: సూర్యోదయం మరియు సూర్యాస్తమయం తిరిగి లెక్కించబడకుండా `sun.sun` ఎంటిటీ నుండి చదవబడతాయి, మరియు `for` వ్యవధి recorder చరిత్ర లేకుండా చివరి స్థితి మార్పు నుండి కొలవబడుతుంది. మినహాయింపు `template`, ఇది ఏ ఇతర [Home Assistant టెంప్లేట్](#టెంప్లేట్లు) లాగానే సర్వర్ ద్వారా రెండర్ చేయబడుతుంది.
>
...
Bubble Card రెండు రకాల టెంప్లేట్‌లకు మద్దతు ఇస్తుంది:

- **Home Assistant టెంప్లేట్‌లు (Jinja)**, మీ ఆటోమేషన్‌లలో, Mushroom లో లేదా card-mod లో మీరు ఇప్పటికే రాసేవి. మద్దతు ఉన్న ఫీల్డ్‌లో `{{ ... }}` లేదా `{% ... %}` ఉంచండి, Home Assistant దాన్ని మీ కోసం లైవ్‌గా రెండర్ చేస్తుంది.
- **JavaScript టెంప్లేట్‌లు**, మీ [కస్టమ్ స్టైల్‌లలో](#స్టైలింగ్) `${ ... }`, కార్డ్ లోపలికే చేరుకోవాల్సిన ఏ పని కోసమైనా.

### Home Assistant టెంప్లేట్‌లు (Jinja)

టెంప్లేట్‌లు మీ Home Assistant సర్వర్ ద్వారా రెండర్ చేయబడతాయి, అవి చదివేది మారినప్పుడు వాటంతట అవే అప్‌డేట్ అవుతాయి. అవి ఈ ఫీల్డ్‌లలో పనిచేస్తాయి:

<details>

<summary><b>మద్దతు ఉన్న ఫీల్డ్‌లు (ఉదాహరణలతో)</b></summary>

| ఫీల్డ్ | ఉదాహరణ |
| --- | --- |
| `name`, ప్రతి కార్డ్‌పై (పాప్-అప్ హెడర్ మరియు విభజనతో సహా) | `name: "{{ states('sensor.living_temp') }} °C"` |
| `icon`, ప్రతి కార్డ్‌పై (ఒక కవర్ యొక్క `icon_open`, `icon_close`, `icon_up` మరియు `icon_down` కూడా) | `icon: "{{ 'mdi:window-open' if is_state('binary_sensor.window', 'on') else 'mdi:window-closed' }}"` |
| ఒక [సబ్-బటన్](#సబ్-బటన్లు) యొక్క `name` మరియు `icon` | `name: "{{ 'Wet' if states(entity) \| float > 60 else 'Dry' }}"` |
| `state_content`, ఒక కార్డ్ లేదా సబ్-బటన్‌పై, `state` మరియు అట్రిబ్యూట్ పేర్ల పక్కన | `state_content: [state, "{{ states('sensor.humidity') }} %"]` |
| ఒక [క్షితిజ సమాంతర బటన్‌ల స్టాక్](#క్షితిజ-సమాంతర-బటన్ల-స్టాక్) యొక్క `1_name`, `1_icon`... | `1_name: "{{ user }}"` |
| ఒక కార్డ్ యొక్క `styles` మరియు ఒక [మాడ్యూల్](#మాడ్యూల్లు) కోడ్, JavaScript టెంప్లేట్‌లతో కలిపి | దిగువ చూడండి |
| [షరతులు](#షరతులు), `condition: template` తో | `value_template: "{{ is_state('sun.sun', 'below_horizon') }}"` |

</details>

> [!IMPORTANT]
> టెంప్లేట్‌ను ఎల్లప్పుడూ కొటేషన్ గుర్తుల మధ్య ఉంచండి. అవి లేకుండా, `name: {{ states('x') }}` ను YAML టెక్స్ట్‌గా కాకుండా ఒక mapping గా చదువుతుంది, మరియు కార్డ్ దాన్ని తిరస్కరిస్తుంది.

Home Assistant అందించే ప్రతిదానికీ (`states()`, `state_attr()`, `is_state()`, `area_entities()`, `expand()`, ఫిల్టర్లు, మీ `custom_templates` ఫోల్డర్‌లోని మాక్రోలు...) అదనంగా మూడు వేరియబుల్స్ అందుబాటులో ఉన్నాయి:

- `entity` అనేది కార్డ్ యొక్క ఎంటిటీ, లేదా సబ్-బటన్ ఫీల్డ్ కోసం ఆ సబ్-బటన్ యొక్క ఎంటిటీ.
- `config.entity` అనేది అదే విలువ, మీరు card-mod కోసం రాసిన టెంప్లేట్‌ల కోసం.
- `user` అనేది లాగిన్ అయిన వినియోగదారు పేరు.

ఫలితాలను Home Assistant డెవలపర్ టూల్స్‌లో లాగానే పార్స్ చేస్తుంది, కాబట్టి `21.50` అనేది `21.5` గా కనిపిస్తుంది. టెక్స్ట్ ఉన్నది ఉన్నట్లుగా ఉండాలంటే `| string` జోడించండి.

<details>

<summary>మీ కస్టమ్ స్టైల్‌లలో Home Assistant టెంప్లేట్‌లు</summary>

<br>

ఒక టెంప్లేట్ ఒక విలువను కలిగి ఉండవచ్చు లేదా పూర్తి CSS రూల్స్‌ను చుట్టి ఉంచవచ్చు:
...
JavaScript టెంప్లేట్‌లు మరియు Home Assistant టెంప్లేట్‌లు ఒకే బ్లాక్‌ను పంచుకోవచ్చు. ప్రతి `${ }` ను `{% if %} ... {% endif %}` బ్లాక్ బయట ఉంచండి, ప్రతి వైపును వేరే ఇంజిన్ రెండర్ చేస్తుంది, మరియు రెండుగా తెగిన బ్లాక్‌ను రెండర్ చేయలేము.

స్టేట్ లైన్‌లో మీ సొంత టెక్స్ట్‌కు స్టైల్‌లు ఏవీ అవసరం లేదు, `state_content` తన ఐటమ్‌లలో ఒకటిగా ఒక టెంప్లేట్‌ను తీసుకుంటుంది:
...
ఒక JavaScript టెంప్లేట్ లోపల, `renderTemplate("{{ ... }}")` ఒక Home Assistant టెంప్లేట్ యొక్క రెండర్ చేసిన టెక్స్ట్‌ను మీకు ఇస్తుంది, ఒక టెంప్లేట్ స్వయంగా చేరుకోలేని చోట్ల కోసం:
...
లోపాలు ఎడిటర్‌లో, కస్టమ్ స్టైల్‌ల కింద, మరియు మీ బ్రౌజర్ కన్సోల్‌లో చూపించబడతాయి.

</details>

### JavaScript టెంప్లేట్‌లు

అధునాతన వినియోగదారులు తమ [కస్టమ్ స్టైల్‌లలో](#స్టైలింగ్) నేరుగా JS లో టెంప్లేట్‌లను జోడించవచ్చు. ఉదాహరణకు, ఇది ఒక ఐకాన్‌ను, టెక్స్ట్‌లను లేదా ఎలిమెంట్ రంగులను డైనమిక్‌గా మార్చడానికి, ఒక స్టేట్, అట్రిబ్యూట్ మరియు మరిన్నింటి ఆధారంగా ఒక ఎలిమెంట్‌ను (సబ్-బటన్ వంటిది) షరతులతో చూపించడానికి లేదా దాచడానికి, లేదా దాదాపు ఏదైనా చేయడానికి మిమ్మల్ని అనుమతిస్తుంది.
...
- `renderTemplate(template, entity)` ఒక Jinja టెంప్లేట్ కోసం Home Assistant రెండర్ చేసిన టెక్స్ట్‌ను తిరిగి ఇస్తుంది, ఉదాహరణకు `${card.querySelector('.bubble-state').innerText = renderTemplate("{{ states('sensor.humidity') }} %")}`. రెండవ ఆర్గ్యుమెంట్ అనేది టెంప్లేట్ `entity` గా చూసేది, డిఫాల్ట్‌గా మీ కార్డ్ యొక్క ఎంటిటీ.
...
మీరు మీ స్టైల్‌ల నుండి స్టేట్ (`.bubble-state`) ను టెంప్లేట్ చేయాలనుకుంటే, `state_content` ఏమి చెప్పినా, ఒక టెంప్లేట్ దానిలో రాసిన వెంటనే ఆ లైన్ స్క్రీన్‌పై కనిపిస్తుంది.

స్టైల్‌లు ఏవీ లేకుండా అదే పని, `state_content` లో ఒక Home Assistant టెంప్లేట్‌తో, ఇది మీకు అనువదించిన స్టేట్‌ను కూడా ఇస్తుంది:
```yaml
